...
sudo bash /home/pi/my_scripts/sensor2hex-file.sh

# export MAJOR="00 01"


# read sensor reding from file as string
major_val=`cat /home/pi/my_scripts/beacon_content_major.ibc`
minor_val=`cat /home/pi/my_scripts/beacon_content_minor.ibc`
power_val=`cat /home/pi/my_scripts/beacon_content_power.ibc`
...
export MINOR="$minor_val"
export POWER="$power_val"
